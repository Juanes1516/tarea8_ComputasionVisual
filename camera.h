...
public:
    ...
    double vfov = 90;              // Campo de visión vertical en grados.
    point3 lookfrom = point3(0, 0, 0);   // Punto de la cámara.
    point3 lookat = point3(0, 0, -1);    // Punto al que se dirige la cámara.
    vec3 vup = vec3(0, 1, 0);      // Vector "up" de la cámara.
    double defocus_angle = 0;      // Ángulo del cono de variación 
...
private:
    ...
    void initialize() {
        ...
        // Calcula el radio del disco de defocus a partir del ángulo.
